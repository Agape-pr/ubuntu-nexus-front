      ...
      <div className="max-w-2xl mx-auto px-4 py-6 space-y-6">
        ...
        {favorites.length === 0 ? (
          <div className="bg-card border border-border rounded-2xl py-16 flex flex-col items-center text-center px-6">
            ...
            <h3 className="font-bold text-white/80 text-lg mb-2">No favorites yet</h3>
            <p className="text-sm text-white/40 mb-6">Tap the heart icon on any product to save it here.</p>
            <Link
