  ...
  return (
    <div className="min-h-screen flex flex-col bg-background">
            ...
            <div className="relative h-[450px] lg:h-[600px] w-full lg:w-[110%] animate-slide-in-right hidden md:block">
              ...
              >
                ...
                <p className="text-xs font-medium text-foreground">
                  <p className="font-bold">Kigali local vendors</p>
                  <p>Best platform ever!</p>
        ...
        <div className="container">
          <div className="mb-12 md:mb-16">
            ...
            <p className="text-muted-foreground text-lg max-w-xl">
              Everything you need to buy and sell confidently, built into one
              cohesive experience designed for the African market.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-4 md:gap-6 auto-rows-[250px]">
            ...
            <div className="md:col-span-2 lg:col-span-2 row-span-2 rounded-3xl relative overflow-hidden group shadow-card bg-secondary">
              ...
              <div className="absolute bottom-0 left-0 p-6 md:p-8 w-full">
                ...
                <p className="text-white/80 line-clamp-2 max-w-md">
                  Connect with sellers in your neighborhood. Support local
                  businesses and grow the circular economy effortlessly.
                </p>
              </div>
            </div>
            ...
            <div className="md:col-span-1 lg:col-span-2 rounded-3xl bg-emerald/10 border border-emerald/20 p-6 md:p-8 flex flex-col justify-end relative shadow-sm group hover:bg-emerald/15 transition-colors">
              ...
              <h3 className="text-2xl font-bold text-emerald-foreground mb-2">
                100% Escrow Protection
              </h3>
              <p className="text-emerald-foreground/80 max-w-sm">
                Your money stays in a secure vault until your order arrives
                perfectly. Not what you ordered? Instant refund.
              </p>
            </div>
            ...
            <div className="rounded-3xl bg-card border border-border p-6 flex flex-col justify-between shadow-sm group hover:shadow-ambient transition-all">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Sign up, add products, get a shareable link in exactly 2
                  minutes.
                </p>
              </div>
            </div>
            ...
            <div className="rounded-3xl bg-primary border-transparent p-6 flex flex-col justify-between shadow-lift group z-10 relative overflow-hidden">
              ...
              <Zap
                size={28}
                className="text-accent group-hover:scale-110 transition-transform relative z-10"
              />
              <div className="relative z-10">
                ...
                <p className="text-sm text-white/70">
                  Powered securely by Pesapal for seamless local transactions.
                </p>
              </div>
            </div>
          </div>
      ...
      >
        ...
        <svg
          className="absolute left-0 top-1/2 -translate-y-1/2 w-full h-[600px] text-secondary -z-10"
          viewBox="0 0 1000 600"
          preserveAspectRatio="none"
          fill="none"
        >
          <path
            d="M0 300C300 300 400 100 700 100C1000 100 1000 300 1200 300"
            stroke="currentColor"
            strokeWidth="2"
            strokeDasharray="8 8"
          />
        ...
        <div className="container">
          <div className="text-center mb-16 relative">
            ...
            <p className="text-muted-foreground text-lg max-w-lg mx-auto">
              Transparent from click to delivery. No surprises.
            </p>
          </div>
          ...
          <div className="relative max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-6">
              {[
                ...
                >
                  <div
                    className={`w-32 h-32 rounded-full ${step.bg} border-8 border-background flex items-center justify-center relative shadow-sm group-hover:scale-105 transition-transform duration-300`}
                  >
                  ...
                  <h3 className="mt-8 mb-2 font-bold text-xl text-foreground group-hover:text-primary transition-colors">
                    {step.title}
                  </h3>
          ...
          <div className="flex flex-col sm:flex-row sm:items-end justify-between mb-10 gap-4">
            <div>
              ...
              <p className="text-muted-foreground mt-2">
                {isSeeded
                  ? "Curated products from your local community"
                  : "Discover products from Kigali's finest sellers"}
              </p>
            </div>
            <Link href="/marketplace">
              <Button
                variant="outline"
                className="rounded-full bg-card hover:bg-secondary gap-2 transition-all border-border shadow-sm hover:shadow-md"
              >
            ...
            {isLoading ? (
              <>
                {[1, 2, 3, 4, 5, 6].map((i) => (
                  <div
                    key={i}
                    className="rounded-3xl bg-card border border-border shadow-sm overflow-hidden animate-pulse"
                  >
              ...
              displayProducts.map((product) => {
                ...
                return (
                  <div
                    key={product.id}
                    className="group bg-card rounded-2xl shadow-card hover:shadow-lift transition-all duration-300 overflow-hidden border border-border/50 hover:border-border"
                  >
                    {/* Image */}
                    <div className="relative h-56 bg-secondary overflow-hidden">
                      {isSeed ? (
                        ...
                        <ProductCard
                          ...
                          storeSlug={(product as any).store_name
                            ?.toLowerCase()
                            .replace(/\s+/g, "-")}
      ...
      <section className="py-20 md:py-32 bg-background relative overflow-hidden flex items-center justify-center">
        ...
        <div className="container relative z-10 max-w-6xl mx-auto">
          <div className="bg-primary rounded-[2.5rem] overflow-hidden shadow-lift relative group">
            {/* Ambient glows */}
            <div className="absolute -top-40 -right-40 w-[500px] h-[500px] bg-accent/20 rounded-full blur-3xl group-hover:scale-110 transition-transform duration-1000 pointer-events-none" />
            <div className="absolute -bottom-40 -left-40 w-[500px] h-[500px] bg-emerald-500/10 rounded-full blur-3xl group-hover:scale-110 transition-transform duration-1000 pointer-events-none" />

            {/* Thin vertical divider line */}
            <div className="absolute left-[38%] top-12 bottom-12 w-px bg-white/10 hidden md:block" />

            <div className="relative z-10 grid md:grid-cols-[2fr_3fr] min-h-[340px]">
              {/* ── LEFT COLUMN — vertical feature list ── */}
              <div className="flex flex-col justify-center gap-5 px-10 py-12 md:py-14 border-b border-white/10 md:border-b-0 md:border-r border-white/[0.07]">
                {[
                  {
                    label: "Zero set-up fees",
                    sub: "Start selling for free, always.",
                  },
                  {
                    label: "Thousands of local buyers",
                    sub: "Reach your neighbourhood instantly.",
                  },
                  {
                    label: "Complete escrow protection",
                    sub: "Every transaction, fully secured.",
                  },
                  {
                    label: "Your storefront awaits",
                    sub: "Live in under 2 minutes.",
                  },
                ].map(({ label, sub }) => (
                  <div
                    key={label}
              ...
              <div className="flex flex-col justify-center px-10 md:px-14 py-12 md:py-14">
                {/* Eyebrow tag */}
                ...
                {/* Main heading */}
                <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight text-white leading-[1.05] mb-6 text-balance">
                  Launch your
                  <br />
                  business on
                  <br />
                  <span className="text-accent">UbuntuNow.</span>
                </h2>
                ...
                >
                  <Button
                    size="lg"
                    className={cn(
                      "relative gradient-amber text-primary font-bold px-8 h-14 text-base rounded-full border-0",
                      "overflow-hidden group",
                      "transition-all duration-300 ease-[cubic-bezier(0.34,1.56,0.64,1)]",
                      "hover:scale-105 hover:-translate-y-0.5 hover:shadow-[0_8px_28px_rgba(234,126,0,0.45)]",
                      "active:scale-[0.97] active:translate-y-0 active:duration-100",
                    )}
                  >
                    {/* Shimmer sweep on hover */}
                    <span className="absolute inset-0 rounded-full bg-[linear-gradient(105deg,transparent_40%,rgba(255,255,255,0.35)_50%,transparent_60%)] -translate-x-full group-hover:translate-x-full transition-transform duration-500 ease-in-out pointer-events-none" />

                    {/* Outer ring pulse on hover */}
                    <span className="absolute -inset-[3px] rounded-full border-2 border-transparent group-hover:border-amber-400/50 group-hover:-inset-[5px] transition-all duration-300 pointer-events-none" />

                    {/* Label shifts left, arrow slides in */}
                    <span className="relative flex items-center gap-2">
                      <span className="transition-transform duration-300 ease-[cubic-bezier(0.34,1.56,0.64,1)] group-hover:-translate-x-1.5">
                        Create your free store now
                      </span>
                      <span className="opacity-0 -translate-x-1 group-hover:opacity-100 group-hover:translate-x-0 transition-all duration-300 ease-[cubic-bezier(0.34,1.56,0.64,1)]">
                        <ArrowRight size={16} />
                      </span>
                    </span>
                  </Button>
                ...
                <p className="mt-5 text-xs text-white/30 flex items-center gap-2">
                  ...
                  No credit card required · 2-min setup · Free forever
                </p>
              </div>
            </div>
          </div>
