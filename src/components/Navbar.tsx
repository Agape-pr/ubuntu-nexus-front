      ...
      <div className="container flex h-14 items-center justify-between gap-4">
        ...
        <nav className="hidden md:flex items-center gap-0.5 flex-1 ml-6">
          ...
          {userRole === "admin" && (
            <Link
              href="/admin"
              className="flex items-center gap-1.5 px-4 py-2 rounded-lg text-sm font-medium text-violet-600 hover:text-violet-700 hover:bg-violet-50/80 transition-all duration-200"
            >
              <Shield size={14} />
              Admin
            </Link>
          ...
          {isLoggedIn ? (
            <div className="flex items-center gap-1">
              ...
              <Button
                variant="ghost"
                size="sm"
                className="h-9 px-3 text-sm font-medium gap-1.5 text-muted-foreground"
        ...
        <div className="md:hidden flex items-center gap-1">
          ...
          {isLoggedIn ? (
            <Link href={userRole === "seller" ? "/dashboard" : "/profile"}>
      ...
      {isOpen && (
        <div className="md:hidden border-t border-border bg-card animate-fade-up">
          <div className="container py-4 flex flex-col gap-1">
            ...
            >
              <Store size={15} /> Start your store
            </Link>
            {userRole !== "seller" && (
              <Link
                href="/cart"
